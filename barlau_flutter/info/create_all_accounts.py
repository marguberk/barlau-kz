#!/usr/bin/env python3
"""
Скрипт для создания аккаунтов всех сотрудников и водителей
"""
...
def create_employee_accounts():
    """Создает аккаунты для всех сотрудников"""
    ...
    employees_data = [
        ...
        {
            'name': 'Сопашев Алмасжан Сематжанович',
            'first_name': 'Алмасжан',
            'last_name': 'Сопашев',
            'phone': '+77057057876',
        ...
        },
        {
            ...
            'phone': '+77000000000',  # номер не указан в файле
            'birth_date': None,
    ...
    # Объединяем всех сотрудников и водителей
    all_people = employees_data + drivers_data
