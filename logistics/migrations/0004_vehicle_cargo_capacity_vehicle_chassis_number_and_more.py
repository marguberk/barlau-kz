...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('logistics', '0003_vehicle_status_vehicle_vehicle_type'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='vehicle',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_vehicles', to=settings.AUTH_USER_MODEL, verbose_name='Кем создан'),
        ),
        migrations.AddField(
            model_name='vehicle',
